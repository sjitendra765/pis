function convert_to_unicode(convert_text)
{
...
//**********************************************
    ...
    while ( chale_chalo == 1 ) 
    {
     ...
     { 
      ...
      while (convert_text.charAt ( sthiti2 ) != ' ') {sthiti2--;}
     } 
     else  { sthiti2 = text_size  ;  chale_chalo = 0 }
      
//   alert(" sthiti 1 = "+sthiti1); alert(" sthit 2 = "+sthiti2) 

     var modified_substring = convert_text.substring ( sthiti1, sthiti2 )  ;
